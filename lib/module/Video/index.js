...
const Video = {
  compress: async (fileUrl, options, onProgress) => {
    ...
    try {
      ...
      if (options !== null && options !== void 0 && options.videoCodec) {
        modifiedOptions.videoCodec = options === null || options === void 0 ? void 0 : options.videoCodec;
      }
